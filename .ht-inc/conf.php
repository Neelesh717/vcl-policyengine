...
define("BASEURL", "https://$ip");   // no trailing slash - all of the URL except /index.php
define("SCRIPT", "/index.php");                 // this should only be "/index.php" unless you rename index.php to something else
define("HELPURL", "http://cwiki.apache.org/VCL/"); // URL pointed to by the "Help" link in the navigation area
...
define("HOMEURL", "https://$ip/"); // url to go to when someone clicks HOME or Logout
