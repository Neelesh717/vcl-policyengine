...
## Policy Engine ##
$actions['mode']['pengine'] = "pengineFunc";
$actions['pages']['pengine'] = "policyengine";
#### 1.Assessment Module
$actions['mode']['assessment'] = "assessmentEngine";
$actions['pages']['assessment'] = "policyengine";
$actions['mode']['viewUserAssessment'] = "viewUserAssessment";
$actions['pages']['viewUserAssessment'] = "policyengine";
$actions['mode']['submitUserAssessment'] = "viewUserAssessment";
$actions['pages']['submitUserAssessment'] = "policyengine";
$actions['mode']['viewImageAssessment'] = "viewImageAssessment";
$actions['pages']['viewImageAssessment'] = "policyengine";
$actions['mode']['submitImageAssessment'] = "viewImageAssessment";
$actions['pages']['submitImageAssessment'] = "policyengine";
$actions['mode']['viewCompAssessment'] = "viewCompAssessment";
$actions['pages']['viewCompAssessment'] = "policyengine";
$actions['mode']['submitCompAssessment'] = "viewCompAssessment";
$actions['pages']['submitCompAssessment'] = "policyengine";
$actions['mode']['viewSchedAssessment'] = "viewSchedAssessment";
$actions['pages']['viewSchedAssessment'] = "policyengine";
$actions['mode']['submitSchedAssessment'] = "viewSchedAssessment";
$actions['pages']['submitSchedAssessment'] = "policyengine";
#### 2.Advising Module
$actions['mode']['advising'] = "advisingEngine";
$actions['pages']['advising'] = "policyengine";
$actions['mode']['compliance'] = "complianceEngine";
$actions['pages']['compliance'] = "policyengine";
$actions['mode']['advisingHomePageWrapper'] = "advisingHomePageWrapperFunc";
$actions['pages']['advisingHomePageWrapper'] = "policyengine";
$actions['mode']['advisingHomePage'] = "advisingHomePageFunc";
$actions['pages']['advisingHomePage'] = "policyengine";
$actions['mode']['maxOverlapRes'] = "maxOverlapResFunc";
$actions['pages']['maxOverlapRes'] = "policyengine";
$actions['mode']['visitingScholar'] = "visitingScholarFunc";
$actions['pages']['visitingScholar'] = "policyengine";
$actions['mode']['blockWinxpRes'] = "blockWinxpResFunc";
$actions['pages']['blockWinxpRes'] = "policyengine";
$actions['mode']['submitPolicyLookup'] = "assessmentEngine";
$actions['pages']['submitPolicyLookup'] = "policyengine";
$actions['mode']['grantImgAccess'] = "grantImgAccessFunc";
$actions['pages']['grantImgAccess'] = "policyengine";
$actions['mode']['accessAndMapping'] = "accessAndMappingFunc";
$actions['pages']['accessAndMapping'] = "policyengine";
$actions['mode']['compositeMultiImage'] = "compositeMultiImageFunc";
$actions['pages']['compositeMultiImage'] = "policyengine";
#### 3.Compliance Module:
$actions['mode']['compliance'] = "complianceEngine";
$actions['pages']['compliance'] = "compliance_engine";
$actions['pages']['complianceSub'] = "compliance_engine";
$actions['mode']['complianceSub'] = "complianceSub";
$actions['pages']['renderPolicyForm'] = "compliance_engine";
$actions['mode']['renderPolicyForm'] = "renderPolicyForm";
$actions['mode']['advisingHomePageWrapper'] = "advisingHomePageWrapperFunc";
$actions['pages']['advisingHomePageWrapper'] = "policyengine";
$actions['mode']['advisingHomePage'] = "advisingHomePageFunc";
$actions['pages']['advisingHomePage'] = "policyengine";
